...
import { CacheDebugPanel, useCacheDebugToggle } from "../components/common/cache-debug-panel";
...
export const Route = createRootRouteWithContext<RouterContext>()({
  ...
  component: () => {
    const { showDebugPanel } = useCacheDebugToggle();
    ...
    return (
      <>
        ...
        {import.meta.env.DEV && showDebugPanel && <CacheDebugPanel />}
      </>
    );
  },
